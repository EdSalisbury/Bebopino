...
class ESP8266 {
 public:
    ...
    /**
     * Register UDP port number in multiple mode (listening).
     *
     * @param addr - the IP or domain name of the target host.
     * @param port - the port number of the target host.
     * @retval true - success.
     * @retval false - failure.
     */
    bool listenUDP(uint8_t mux_id, uint32_t port);

    /**
     * Register UDP port number in single mode (listening).
     *
     * @param addr - the IP or domain name of the target host.
     * @param port - the port number of the target host.
     * @retval true - success.
